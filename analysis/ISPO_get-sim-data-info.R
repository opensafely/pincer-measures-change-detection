...
write.csv(measure_monthly_summary  , file=glue("{output_dir}/ISPO_s-data_monthly.csv"  ))
write.csv(measure_quarterly_summary, file=glue("{output_dir}/ISPO_s-data_quarterly.csv"))
